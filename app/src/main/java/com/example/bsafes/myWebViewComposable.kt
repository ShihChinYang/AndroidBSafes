...
fun MyWebView(
    ...
    val myBillingClient = remember {
        MyBillingClient(appContext as Activity)
    }
    ...
    class MyJavascriptInterface(private val context:Context, private val billingClient: MyBillingClient) {
        @JavascriptInterface
